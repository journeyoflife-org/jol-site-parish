...
export function generateMetadata(): Metadata {
  ...
  return {
    title: `${name} — Parish Church Landing | ${tenant.slug}`,
    alternates: {
...
export default function ParishPage() {
  ...
  const churchEntity = buildChurchEntity({
    ...
    additionalProperty: [{ name: "designation", value: "parish" }]
  });
  ...
  return (
    <>
      ...
      {/* Schedule */}
      <section aria-label="Mass schedule" className="py-12 px-4">
      ...
      {/* Contact */}
      <section aria-label="Contact information" className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
